...
export default function Nav({ cartItemsCount = 0, user = null, onLogout = null, darkMode = false, toggleDarkMode = null }) {
  ...
  return (
    <div className='nav-container'>
      ...
      <div className={`nav-links ${isMenuOpen ? 'nav-open' : ''}`}>
        ...
        {user ? (
          <>
            ...
            {['yahiapro400@gmail.com', 'admin-test@gmail.com', 'admin@gmail.com'].includes(user.email) && (
              <>
      ...
      <Link to='/' className={`nav-brand ${user && ['yahiapro400@gmail.com', 'admin-test@gmail.com', 'admin@gmail.com'].includes(user.email) ? 'admin-brand' : ''}`} onClick={closeMenu}>
        <img 
          ...
          className="nav-logo"
        />
        <span className={`nav-brand-text ${user && ['yahiapro400@gmail.com', 'admin-test@gmail.com', 'admin@gmail.com'].includes(user.email) ? 'admin-text' : ''}`}>
          Store
        </span>
      </Link>
